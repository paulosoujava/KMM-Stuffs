package com.paulo.kmm.android.demos
...
import com.paulo.kmm.android.ui.BottomButton
import com.paulo.kmm.android.ui.MyApplicationTheme
...
fun FullScreenMessagePreviewWithShimmer() {
    MyApplicationTheme {
        // shimmer aplicado
        val viewModel = ShimmerViewModel().apply { toggle() }
        FullScreenMessageDialog(
            icon = com.paulo.kmm.android.android.R.drawable.ic_android_black_24dp,
