...
# 4) create a folder called tools > create to file decrypt_secrets.sh and encrypt_secret.sh
# 5) on your terminal locate tools and run:
#   - chmod +x decrypt_secrets.sh (make it executable)
#   - chmod +x encrypt_secret.sh (make it executable)
...
#     - in your terminal type > ./tools/encrypt_secret.sh
